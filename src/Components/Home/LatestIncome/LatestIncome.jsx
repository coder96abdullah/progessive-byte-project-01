...
const LatestIncome = () => {
        ...
        series: [
            {
                ...
                data: [
                    { value: 700, name: 'Product Sales' },
                    { value: 300, name: 'Maintenance Sales' }
                ]
            }
        ]
    };
    ...
    const transactions = [
        { date: "2024-11-01", vendor: "Vance Rollins", amount: "$500.00" },
        { date: "2024-11-02", vendor: "Acme Supplies", amount: "$750.00" },
        { date: "2024-11-03", vendor: "Tech Solutions", amount: "$300.00" },
        { date: "2024-11-04", vendor: "Global Enterprises", amount: "$450.00" },
        { date: "2024-11-05", vendor: "Creative Designs", amount: "$600.00" }
    ];
                            ...
                            <tbody className='text-[#1B2559] text-[14px] font-[500]'>
                                {transactions.map((transaction) => (
                                    <tr key={transaction.date}>
                                        <td className='px-10 py-5'>{transaction.date}</td>
